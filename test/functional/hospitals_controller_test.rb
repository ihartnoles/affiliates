...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { affiliate_id: @hospital.affiliate_id, id: @hospital.id, name: @hospital.name, name_listed: @hospital.name_listed }
    end
  ...
  test "should update hospital" do
    put :update, id: @hospital, hospital: { affiliate_id: @hospital.affiliate_id, id: @hospital.id, name: @hospital.name, name_listed: @hospital.name_listed }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
